...
#ifndef RTW_HEADER_Control_Mov_PI_Digilent_h_
#define RTW_HEADER_Control_Mov_PI_Digilent_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef Control_Mov_PI_Digilent_COMMON_INCLUDES_
# define Control_Mov_PI_Digilent_COMMON_INCLUDES_
...
#endif                                 /* Control_Mov_PI_Digilent_COMMON_INCLUDES_ */

#include "Control_Mov_PI_Digilent_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_Control_Mov_PI_Digilent RT_MODEL_Control_Mov_PI_Digilent_T

/* Definition for use in the target main file */
#define Control_Mov_PI_Digilent_rtModel RT_MODEL_Control_Mov_PI_Digilent_T
...
typedef struct {
  ...
  real_T EncoderGradosReductora153;    /* '<Root>/Encoder-Grados Reductora 1:53' */
  real_T Sum;                          /* '<Root>/Sum' */
...
} B_Control_Mov_PI_Digilent_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T TimeStampA;                   /* '<S4>/Ideal Derivative' */
  real_T LastUAtTimeA;                 /* '<S4>/Ideal Derivative' */
  real_T TimeStampB;                   /* '<S4>/Ideal Derivative' */
  real_T LastUAtTimeB;                 /* '<S4>/Ideal Derivative' */
  real_T PCI6221DA_RWORK[6];           /* '<Root>/PCI-6221 DA' */
  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_b;                 /* '<S2>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_c;                 /* '<S3>/S-Function' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK;                      /* '<S8>/FromWs' */

  int_T PCI6221DA_IWORK[41];           /* '<Root>/PCI-6221 DA' */
  struct {
    int_T AcquireOK;
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_o;                 /* '<S6>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_e;                 /* '<S7>/S-Function' */
} DW_Control_Mov_PI_Digilent_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<S4>/Integrator' */
} X_Control_Mov_PI_Digilent_T;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<S4>/Integrator' */
} XDot_Control_Mov_PI_Digilent_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<S4>/Integrator' */
} XDis_Control_Mov_PI_Digilent_T;
...
#define rtB                            Control_Mov_PI_Digilent_B
#define BlockIO                        B_Control_Mov_PI_Digilent_T
#define rtX                            Control_Mov_PI_Digilent_X
#define ContinuousStates               X_Control_Mov_PI_Digilent_T
#define rtXdot                         Control_Mov_PI_Digilent_XDot
#define StateDerivatives               XDot_Control_Mov_PI_Digilent_T
#define tXdis                          Control_Mov_PI_Digilent_XDis
#define StateDisabled                  XDis_Control_Mov_PI_Digilent_T
#define rtP                            Control_Mov_PI_Digilent_P
#define Parameters                     P_Control_Mov_PI_Digilent_T
#define rtDWork                        Control_Mov_PI_Digilent_DW
#define D_Work                         DW_Control_Mov_PI_Digilent_T

/* Parameters (auto storage) */
struct P_Control_Mov_PI_Digilent_T_ {
  real_T PIController_D;               /* Mask Parameter: PIController_D
...
struct tag_RTM_Control_Mov_PI_Digilent_T {
  const char_T *path;
...
extern P_Control_Mov_PI_Digilent_T Control_Mov_PI_Digilent_P;

/* Block signals (auto storage) */
extern B_Control_Mov_PI_Digilent_T Control_Mov_PI_Digilent_B;

/* Continuous states (auto storage) */
extern X_Control_Mov_PI_Digilent_T Control_Mov_PI_Digilent_X;

/* Block states (auto storage) */
extern DW_Control_Mov_PI_Digilent_T Control_Mov_PI_Digilent_DW;

/* Model entry point functions */
extern void Control_Mov_PI_Digilent_initialize(void);
extern void Control_Mov_PI_Digilent_output(void);
extern void Control_Mov_PI_Digilent_update(void);
extern void Control_Mov_PI_Digilent_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Control_Mov_PI_Digilent_rtModel *Control_Mov_PI_Digilent(void);
...
extern RT_MODEL_Control_Mov_PI_Digilent_T *const Control_Mov_PI_Digilent_M;
 ...
 *
 * '<Root>' : 'Control_Mov_PI_Digilent'
 * '<S1>'   : 'Control_Mov_PI_Digilent/Control Host'
 * '<S2>'   : 'Control_Mov_PI_Digilent/Error File'
 * '<S3>'   : 'Control_Mov_PI_Digilent/Error Host'
 * '<S4>'   : 'Control_Mov_PI_Digilent/PI Controller'
 * '<S5>'   : 'Control_Mov_PI_Digilent/Scope '
 * '<S6>'   : 'Control_Mov_PI_Digilent/Seguimiento Host'
 * '<S7>'   : 'Control_Mov_PI_Digilent/Seguimiento Target'
 * '<S8>'   : 'Control_Mov_PI_Digilent/Trayectoria Posicion'
 */
#endif                                 /* RTW_HEADER_Control_Mov_PI_Digilent_h_ */
