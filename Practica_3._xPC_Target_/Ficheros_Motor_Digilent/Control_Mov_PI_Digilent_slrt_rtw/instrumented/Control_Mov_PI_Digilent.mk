...
MODEL           = Control_Mov_PI_Digilent
MODULES         = rt_matrx.c rt_printf.c rt_logging.c Control_Mov_PI_Digilent_capi.c Control_Mov_PI_Digilent_data.c Control_Mov_PI_Digilent_xcp.c Control_Mov_PI_Digilent_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = Control_Mov_PI_Digilent.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = E:\Master\HIL\Practica_3._xPC_Target_\Ficheros_Motor_Digilent
S_FUNCTIONS     = danipcim.c encnipcim.c xpcionim.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 1
...
MODELLIB                  = Control_Mov_PI_Digilentlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Control_Mov_PI_Digilent_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Control_Mov_PI_Digilent_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
